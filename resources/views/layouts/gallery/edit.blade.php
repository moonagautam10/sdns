                    ...
                    <div class="col-md-12" style="text-align: right; padding: 20px 0;">
                        <a  href="{{route('getManageGallery')}}" class="btn btn-primary">Manage  Gallery
                            ...
                            <div class="card bg-light mt-3">        
                                ...
                                <div class="card-body"> 
                                        <form action="{{route('postEditGallery',$gallery->id)}}" method="post">
                                            @csrf
                                            <div class="form-group">
                                                <label class="float-left" for="title">Title</label>
                                                <input class="form-control"   value="{{$gallery->title}}"  name="title">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Photo</label>
                                                <input type="file" class="form-control" name="photo" style="opacity:1; z-index:1;"><br/>
                                                <img src="{{asset('site/img/gallery/'.$gallery->photo)}}" alt="" width="100">
                                            </div>
