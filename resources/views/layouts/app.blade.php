...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100" style="background:  #007bff;">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <x-jet-nav-link href="{{route('getManageNoticeboard')}}">
                                    {{ __('Notice Board') }}
                                </x-jet-nav-link>
                                <x-jet-nav-link href="{{route('getManageNews')}}">
                                    {{ __('News') }}
                                </x-jet-nav-link>
                                <x-jet-nav-link href="{{route('getManageTeam')}}">
                                    {{ __('Team') }}
                                </x-jet-nav-link>
                                <x-jet-nav-link href="{{route('getManageFeature')}}">
                                    {{ __('Features') }}
                                </x-jet-nav-link>
                                <x-jet-nav-link href="{{route('getManageGallery')}}">
                                    {{ __('Gallery') }}
                                </x-jet-nav-link>
